...
$wpsf_settings[] = array(
    ...
    'fields' => array(
		...
		array(
            'id' => 'min_zoom',
            'title' => 'Min. zoom',
            'desc' => 'Select the min. zoom of the map.',
            'type' => 'select',
            'std' => '0',
            'choices' => array(
				'0' => '0',
		...
		array(
            'id' => 'autofit',
            'title' => 'Autofit <sup class="cspm_new_tag">NEW</sup>',
		...
		array(
            'id' => 'transit_layer',
            'title' => 'Transit Layer <sup class="cspm_new_tag">NEW</sup>',
		...
		array(
            'id' => 'show_user',
            'title' => 'Show user location? <sup class="cspm_new_tag">NEW</sup>',
		...
		array(
            'id' => 'user_marker_icon',
            'title' => 'User Marker image <sup class="cspm_new_tag">NEW</sup>',
		...
		array(
            'id' => 'user_map_zoom',
            'title' => 'Geotarget Zoom <sup class="cspm_new_tag">NEW</sup>',
		...
		array(
            'id' => 'user_circle',
            'title' => 'Draw a Circle around the user\'s location <sup class="cspm_new_tag">NEW</sup>',
...
$wpsf_settings[] = array(
    ...
    'fields' => array(
		array(
            ...
            'title' => '<span class="section_sub_title cspacing_notice">! The Custom Map Style can not be operated without activating the option "Custom style" in "Map Settings => Initial style"</span>',
            'desc' => '',
            'type' => 'custom',
        ),		
        array(
...
$wpsf_settings[] = array(
    ...
    'section_title' => 'Infobox Settings <sup class="cspm_plus_tag">Plus+</sup>',
...
?&gt;</pre>',
		...
		array(
            ...
            'title' => 'Remove Infobox on mouseout? <sup class="cspm_new_tag">NEW</sup>',
		...
		array(
            ...
            'title' => 'Post URL',
            'desc' => 'Select a way to open the single post page. You can also disable links in the infoboxes by selecting the option "Disable"',
            'type' => 'radio',
            'std' => 'same_window',
            'choices' => array(
...
$wpsf_settings[] = array(
    ...
    'section_title' => 'KML Layers Settings <sup class="cspm_new_tag">NEW</sup>',
    ...
    'fields' => array(
		array(
 		...
 		array(
            ...
            'desc' => 'Supply a link to a KML file or KMZ file that\'s already <span style="color:red">hosted on the Internet</span>. You can use this <a target="_blank" href="https://kml-samples.googlecode.com/svn/trunk/interactive/index.html">online tool</a> to build your kml file. <br />Find more details about the KML Layers at <a target="_blank" href="https://support.google.com/mapsengine/answer/2505884?hl=en">https://support.google.com/mapsengine/answer/2505884?hl=en</a>.
					   <br /><span style="color:red">1. Note: You can use the Media Library to upload your file and then paste its URL in this field.</span>
...
$wpsf_settings[] = array(
    ...
    'section_title' => 'Overlays Settings <sup class="cspm_new_tag">NEW</sup>',
...
$wpsf_settings[] = array(
    ...
    'section_title' => 'Troubleshooting & Configs',
    'section_description' => '',
    'section_order' => 15,
    'fields' => array(
		array(
