...
/*  Copyright 2015  Ian  (email : ian@odihost.com)
...
if (!class_exists("Easy301redirect")) {
	...
	class Easy301redirect {
		...
		?>
			...
			?>Add your redirect below. Use this format [old url,new url]. <br/>For example [/blog,http://www.google.com], will redirect <?php echo get_option("siteurl")."/blog";?> to http://www.google.com<br/>
